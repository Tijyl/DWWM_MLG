...
$apple1 = new Fruit("POMME Belchard Sud‑Ouest cat.I","apple1.png",78,1);
$apple1->afficherImage();

$apple2 = new Fruit("POMME Golden Sud‑Ouest cat.I","apple2.png",150,1);
$apple2->afficherImage();

$apple3 = new Fruit("POMME Bicolore Centre‑Ouest biologique","apple3.png",6,1.40);
