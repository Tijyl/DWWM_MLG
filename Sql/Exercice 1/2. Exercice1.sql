...
--
-- Base de donnees :  `exercice1`
--

DROP DATABASE IF EXISTS `exercice1`;
CREATE DATABASE IF NOT EXISTS `exercice1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `exercice1`;
...
--
-- Dechargement des donnees de la table `clients`
--
